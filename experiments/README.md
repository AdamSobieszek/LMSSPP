...
```bash
/opt/anaconda3/envs/manip311/bin/python scripts/run_experiment.py finite_horizon_comparison
```
...
```bash
/opt/anaconda3/envs/manip311/bin/python scripts/run_experiment.py finite_horizon_animation_batch
/opt/anaconda3/envs/manip311/bin/python scripts/run_experiment.py experiments/timestep_sweep.yaml
```
...
output_dir: temp_research/finite_horizon_comparison_yaml
...
- `finite_horizon_animation_batch`: run several finite-horizon comparison cases
  and write per-case plots, metrics, animations, and a batch report.
...
- For `finite_horizon_animation_batch`, put shared knobs under `params` and
  per-case overrides under `cases`.
